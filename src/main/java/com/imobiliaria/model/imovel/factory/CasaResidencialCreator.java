...
public class CasaResidencialCreator implements ImovelCreator{
    ...
    public Imovel_CleitonErinaGabriel criar(Map<String, Object> data) {
        ...
        return new CasaResidencial_CleitonErinaGabriel(
                endereco, dataConstrucao, areaTotal, areaConstruida,
                qtdDormitorios, qtdBanheiros, qtdVagasGaragem,
                valorIPTU, valorVenda, valorAluguel, tipoOperacao
        );
    }
}
